        ...
        <div className="flex flex-wrap items-center gap-3">
            {['Patron', 'Genel Müdür', 'Admin'].includes(role) && (
              <div className="flex items-center gap-2 mr-2">
                 <button onClick={handleExportPdf} className="flex items-center gap-2 px-5 py-3 bg-slate-900 border border-slate-700 hover:bg-slate-800 text-white rounded-xl shadow-sm transition-all text-xs font-bold uppercase tracking-wide active:scale-95">
                    <Download size={16} />
                    PDF İndir
                 </button>
                 <button onClick={handleExportExcel} className="flex items-center gap-2 px-5 py-3 bg-emerald-600 border border-emerald-500 hover:bg-emerald-700 text-white rounded-xl shadow-sm transition-all text-xs font-bold uppercase tracking-wide active:scale-95">
                    <FileSpreadsheet size={16} />
                    Excel Aktar
                 </button>
              </div>
            )}
            <div className="flex items-center gap-3 px-6 py-3 bg-indigo-50 rounded-2xl border border-indigo-100 shadow-sm">
