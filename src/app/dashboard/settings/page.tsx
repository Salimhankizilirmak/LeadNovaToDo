                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                           ...
                           {isBoss && (
                              <button
                                 ...
                                 className="bg-indigo-600 hover:bg-indigo-700 text-white px-8 py-4 sm:py-0 rounded-2xl text-xs font-black uppercase tracking-widest shadow-lg shadow-indigo-200 transition-all active:scale-95 disabled:opacity-50 flex items-center justify-center gap-2"
                              >
